...
@Mod(MoreVanillaArmors.MOD_ID)
public class MoreVanillaArmors {
    public static final String MOD_ID = "morevanillaarmors";
    public static final Logger LOGGER = LogUtils.getLogger();

    // The constructor for the mod class is the first code that is run when your mod is loaded.
    // FML will recognize some parameter types like IEventBus or ModContainer and pass them in automatically.
    public MoreVanillaArmors(IEventBus modEventBus, ModContainer modContainer) {
    ...
    @EventBusSubscriber(modid = MoreVanillaArmors.MOD_ID, bus = EventBusSubscriber.Bus.MOD, value = Dist.CLIENT)
