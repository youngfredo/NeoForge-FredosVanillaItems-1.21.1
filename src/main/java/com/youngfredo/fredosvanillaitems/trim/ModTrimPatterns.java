...
public class ModTrimPatterns {
    public static final ResourceKey<TrimPattern> YOUNGFREDO = ResourceKey.create(Registries.TRIM_PATTERN,
            ResourceLocation.fromNamespaceAndPath(FredosVanillaItems.MOD_ID, "youngfredo"));

    public static void bootstrap(BootstrapContext<TrimPattern> context) {
        register(context, ModItems.YOUNGFREDO_SMITHING_TEMPLATE, YOUNGFREDO);
    }
